			...
			<div class="javaex-page-body">
				<div class="javaex-main">
					<form id="form">
						...
						<div class="javaex-unit clear">
							<div class="javaex-unit-left tl"><p class="subtitle required">登录密码</p></div>
							<div class="javaex-unit-right">
								<input type="password" class="javaex-text" id="password" name="password" value="" placeholder="请输入登录密码" data-type="required" autocomplete="off" />
							</div>
						</div>
						<div class="javaex-unit clear">
